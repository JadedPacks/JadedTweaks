	...
	private static void addRecipes() {
		if(Loader.isModLoaded("RedstoneArsenal")) {
			if(Parts.upgradeEFlux != null) {
				...
				GameRegistry.addRecipe(new ShapedOreRecipe(Parts.upgradeEFlux, "FFF", "PPP", "RGR", 'F', "ingotElectrumFlux", 'P', "dustPlastic", 'R', "dustRedstone", 'G', "nuggetGold"));
			}
		}
		if(Loader.isModLoaded("ThermalExpansion")) {
			if(Parts.upgradeEnder != null) {
				RecipeRemover.removeAnyRecipe(Parts.upgradeEnder);
				GameRegistry.addRecipe(new ShapedOreRecipe(Parts.upgradeEnder, "FFF", "PPP", "RGR", 'F', "ingotEnderium", 'P', "dustPlastic", 'R', "dustRedstone", 'G', "nuggetGold"));
			}
		}
		if(Loader.isModLoaded("TConstruct")) {
			if(Parts.upgradeMany != null) {
				RecipeRemover.removeAnyRecipe(Parts.upgradeMany);
				GameRegistry.addRecipe(new ShapedOreRecipe(Parts.upgradeMany, "FFF", "PPP", "RGR", 'F', "ingotManyullyn", 'P', "dustPlastic", 'R', "dustRedstone", 'G', "nuggetGold"));
			}
		}
		if(Loader.isModLoaded("Thaumcraft")) {
			if(Parts.upgradeThaum != null) {
				RecipeRemover.removeAnyRecipe(Parts.upgradeThaum);
				GameRegistry.addRecipe(new ShapedOreRecipe(Parts.upgradeThaum, "FFF", "PPP", "RGR", 'F', "ingotThaumium", 'P', "dustPlastic", 'R', "dustRedstone", 'G', "nuggetGold"));
			}
		}
		if(Loader.isModLoaded("Botania")) {
			if(Parts.upgradeMSteel != null) {
				RecipeRemover.removeAnyRecipe(Parts.upgradeMSteel);
				GameRegistry.addRecipe(new ShapedOreRecipe(Parts.upgradeMSteel, "FFF", "PPP", "RGR", 'F', "ingotManasteel", 'P', "dustPlastic", 'R', "dustRedstone", 'G', "nuggetGold"));
			}
		}
