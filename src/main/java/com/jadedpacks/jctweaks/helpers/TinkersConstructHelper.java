...
public class TinkersConstructHelper {
	...
	private static void addRecipes() {
		GameRegistry.addRecipe(new ShapedOreRecipe(Parts.heart6, "EH", "CX", 'E', "gemEmerald", 'H', Parts.heart5, 'C', Parts.heart4));
		GameRegistry.addRecipe(new ShapedOreRecipe(Parts.heart2, "EH", "CX", 'E', "tincanister", 'H', Parts.heart1, 'C', Parts.heart));
		GameRegistry.addRecipe(new ShapedOreRecipe(Parts.heart4, "EH", "CX", 'E', "ingotGold", 'H', Parts.heart3, 'C', Parts.heart2));
