...
public class ThaumcraftHelper {
	...
	private static void setupResearch() {
		if(Loader.isModLoaded("recallstones")) {
			...
			new JCResearchItem("RECALLSTONE", "AGRIMANCY", new AspectList().add(Aspect.MAGIC, 3).add(Aspect.MOTION, 2), 2, 0, 2, Parts.recallStone).setPages(new ResearchPage[] {
				new ResearchPage("jctweaks.research_page.RECALLSTONE"),
				new ResearchPage((IArcaneRecipe) ThaumcraftApi.addArcaneCraftingRecipe("RECALLSTONE", Parts.recallStone, new AspectList().add(Aspect.EARTH, 5).add(Aspect.ORDER, 3), "SES", "EDE", "SES", Character.valueOf('S'), Parts.stone, Character.valueOf('E'), Parts.epearl, Character.valueOf('D'), Parts.diamond))
			}).setParents(new String[] {
				"RESEARCH"
			}).registerResearchItem();
			new JCResearchItem("DIMENSIONSTONE", "AGRIMANCY", new AspectList().add(Aspect.ELDRITCH, 3).add(Aspect.MOTION, 2), 2, -1, 2, Parts.dimensionStone).setPages(new ResearchPage[] {
				new ResearchPage("jctweaks.research_page.DIMENSIONSTONE"),
				new ResearchPage((IArcaneRecipe) ThaumcraftApi.addArcaneCraftingRecipe("DIMENSIONSTONE", Parts.dimensionStone, new AspectList().add(Aspect.ENTROPY, 5).add(Aspect.ORDER, 3), "BEB", "ERE", "BEB", Character.valueOf('B'), Parts.blazerod, Character.valueOf('E'), Parts.epearl, Character.valueOf('R'), Parts.recallStone))
			}).setParents(new String[] {
				"RECALLSTONE"
			}).registerResearchItem();
		...
		if(Loader.isModLoaded("ThermalExpansion")) {
			new JCResearchItem("MAGICORES", "AGRIMANCY", new AspectList().add(Aspect.METAL, 8).add(Aspect.ENTROPY, 5).add(Aspect.EXCHANGE, 4), 1, 0, 2, Parts.fireOre).setPages(new ResearchPage[] {
				new ResearchPage("jctweaks.research_page.MAGICORES"),
				new ResearchPage((CrucibleRecipe) ThaumcraftApi.addCrucibleRecipe("MAGICORES", Parts.airOre, Parts.stone, new AspectList().add(Aspect.AIR, 10).add(Aspect.EXCHANGE, 3))),
				...
				new ResearchPage((CrucibleRecipe) ThaumcraftApi.addCrucibleRecipe("MAGICORES", Parts.mithrilOre, Parts.tinOre, new AspectList().add(Aspect.MAGIC, 5).add(Aspect.EXCHANGE, 3)))
			}).setParents(new String[] {
					"RESEARCH"
			}).registerResearchItem();
		}
		if(Parts.heart1 != null && Parts.heart3 != null && Parts.heart5 != null && Parts.necrotic != null && Parts.magnumtorch != null) {
			new JCResearchItem("PROTECTION", "AGRIMANCY", (new AspectList()).add(Aspect.LIFE, 8).add(Aspect.SOUL, 5).add(Aspect.ARMOR, 4), 3, 0, 2, Parts.heart1).setPages(new ResearchPage[] {
				new ResearchPage("jctweaks.research_page.PROTECTION"),
				new ResearchPage((CrucibleRecipe) ThaumcraftApi.addCrucibleRecipe("PROTECTION", Parts.heart1, Parts.diamond, new AspectList().add(Aspect.LIFE, 5).add(Aspect.SOUL, 3).add(Aspect.ARMOR, 3))),
				...
				new ResearchPage((CrucibleRecipe) ThaumcraftApi.addCrucibleRecipe("PROTECTION", Parts.magnumtorch, Parts.blockDiamond, new AspectList().add(Aspect.LIGHT, 5).add(Aspect.SOUL, 3).add(Aspect.ARMOR, 3)))
			}).setParents(new String[] {
				"RESEARCH"
			}).registerResearchItem();
		...
		if(Loader.isModLoaded("ForbiddenMagic") && (Loader.isModLoaded("harvestcraft"))) {
			new JCResearchItem("SINFULL", "AGRIMANCY", new AspectList().add(Aspect.LIFE, 8).add(Aspect.SOUL, 5).add(Aspect.ENERGY, 5), 0, 0, 2, Parts.gluttonShard).setPages(new ResearchPage[] {
				new ResearchPage("jctweaks.research_page.SINFULL"),
				new ResearchPage((CrucibleRecipe) ThaumcraftApi.addCrucibleRecipe("SINFULL", Parts.wrathShard, Parts.tnt, new AspectList().add(Aspect.ENTROPY, 5).add(Aspect.SOUL, 3).add(Aspect.EXCHANGE, 3))),
				...
				new ResearchPage((CrucibleRecipe) ThaumcraftApi.addCrucibleRecipe("SINFULL", Parts.gluttonShard, Parts.beefwellington, new AspectList().add(Aspect.HUNGER, 5).add(Aspect.SOUL, 3).add(Aspect.EXCHANGE, 3)))
			}).setParents(new String[] {
				"RESEARCH"
			}).registerResearchItem();
		...
		if(Loader.isModLoaded("customnpcs")) {
			new JCResearchItem("ULTIMATE", "AGRIMANCY", new AspectList().add(Aspect.BEAST, 20).add(Aspect.SOUL, 20).add(Aspect.ENERGY, 20), 1, -1, 2, Parts.diamond).setPages(new ResearchPage[] {
				new ResearchPage("jctweaks.research_page.ULTIMATE"),
				new ResearchPage((CrucibleRecipe) ThaumcraftApi.addCrucibleRecipe("ULTIMATE", Parts.goldcoin, Parts.goldingot, new AspectList().add(Aspect.MAGIC, 5).add(Aspect.GREED, 3).add(Aspect.EXCHANGE, 3))),
